...
const softwareSchema = {
  ...
  operatingSystem: 'Web',
  url: 'https://fmeatool.ai',
  description:
    'AI-powered FMEA generator for automated Failure Mode and Effect Analysis. Create DFMEA and PFMEA reports instantly and export to Excel.',
  offers: [
    {
      '@type': 'Offer',
      name: '50 Credits',
    ...
    {
      '@type': 'Offer',
      name: '1500 Credits (1000 + 500 Bonus)',
      price: '500',
      priceCurrency: 'USD',
      availability: 'https://schema.org/InStock'
    }
