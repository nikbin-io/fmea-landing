import { DFMEA_HEAD, DFMEA_BODY } from '~/constants/dfmea-table'
          ...
          <tbody className="all-[td]:b-solid all-[td]:b-1 all-[td]:p-2  all-[td]:border-gray-light">
            {DFMEA_BODY.map((row, rIdx) => (
              <tr bg="white hover:gray-lighter" className="group" key={rIdx}>
                ...
                {/* STRUCTURE */}
                <td>{row.structure_nextHigher}</td>
                <td>{row.structure_focus}</td>
                <td>{row.structure_nextLower}</td>

                {/* FUNCTION */}
                <td>{row.func_nextHigher}</td>
                <td>{row.func_focus}</td>
                <td>{row.func_nextLower}</td>
                ...
                <td text="center">{row.opt_dfmeaAp}</td>
                <td text="center">{row.opt_filter}</td>
